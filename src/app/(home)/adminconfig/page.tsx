    ...
    >
      ...
      <fieldset style={{ padding: "10px" }}>
        ...
        <label>
          ...
          <input
            type="number"
            step="0.01"
            {...register("VAULT_DISPLAY_MULTIPLIER", { required: true })}
          />
        </label>
        ...
        <label>
          ...
          <input
            type="number"
            step="0.01"
            {...register("MAX_PAYOUT_PERCENT_OF_VAULT", { required: true })}
          />
        </label>
        ...
        <label>
          ...
          <input
            type="number"
            step="0.01"
            {...register("MAX_SINGLE_BET_RATIO", { required: true })}
          />
        </label>
        ...
        <label>
          ...
          <input
            type="number"
            step="0.01"
            {...register("ABSOLUTE_MAX_CRASH", { required: true })}
          />
        </label>
        ...
        <label>
          ...
          <input
            type="number"
            {...register("VAULT_SYNC_INTERVAL", { required: true })}
          />
        </label>
      </fieldset>
      ...
      <fieldset style={{ padding: "10px" }}>
        ...
        <label>
          ...
          <input
            type="text"
            {...register("vaultWallet", { required: true })}
          />
        </label>
      ...
      <fieldset style={{ padding: "10px" }}>
        ...
        <label>
          ...
          <input
            type="text"
            {...register("mongodbUri", { required: true })}
          />
        </label>
      </fieldset>
